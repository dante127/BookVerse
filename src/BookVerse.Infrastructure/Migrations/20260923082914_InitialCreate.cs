    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAuthors", x => new { x.BookId, x.AuthorId, x.Role });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeltaPages = table.Column<int>(type: "int", nullable: false),
                    PreviousPage = table.Column<int>(type: "int", nullable: false),
                    NewPage = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteGenreIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreferredAuthorIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authors_FollowersCount",
                table: "Authors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingHistories_Timestamp",
                table: "ReadingHistories",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBooks_LastReadAt",
                table: "UserBooks",
                column: "LastReadAt");

            migrationBuilder.CreateIndex(
                name: "IX_UserBooks_Status",
                table: "UserBooks",
                column: "Status");
